...
begin
    ...
    plt.show()
    f.savefig("./test_confidence.pdf",bbox_inches="tight")
end
...
begin
    ...
    plt.text(-0.4, 400, raw"No d-wave", fontsize=9, color="black")  # Adjust text position as needed
    plt.text(1.05, 400, raw"Exist d-wave", fontsize=9, color="black")  # Adjust text position as needed
    ...
    plt.show()
    f.savefig("./hypothesis_test_histogram.pdf",bbox_inches="tight")
end
mean(dwave_300)
0.05/mean(dwave_300)
